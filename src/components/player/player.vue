<template>
  <div class="player" v-show="playList.length>0">
    <transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
      ...
      <div class="middle" @touchstart.prevent="midlleTouchStart" @touchmove.prevent="middleTouchMove" @touchend="middleTouchEnd">
    ...
    methods: {
      ...
      enter(el, done) {
        ...
        let animation = {
          ...
          60: {
            transform: 'translate3d(0, 0, 0) scale(1.2) rotate(300deg)'
          },
          100: {
      ...
      leave(el, done) {
        ...
        const {x, y, scale} = this._getPosAndScale()
        this.$refs.cdWrapper.style[transform] = `translate3d(${x}px, ${y}px, 0) scale(${scale}) rotate(360deg)`
